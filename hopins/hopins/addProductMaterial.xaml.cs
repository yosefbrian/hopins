...
namespace hopins
{
    ...
    /// </summary>
    public sealed partial class addProductMaterial : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var parameters = (addProductCategory.ProductParams)e.Parameter;
        ...
        private void next_Click(object sender, RoutedEventArgs e)
        {
            ...
            parameter.Material = textBox.Text;
            this.Frame.Navigate(typeof(addProductPrice), parameter);
                ...
                await dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () =>
                {
                    ...
                    if (textBox.IsEnabled == true)
                    {
                        ...
                        if (args.Result.Text != null)
                        {
                            ...
                            string help = string.Format("The material of your product is {0} , if the type is correct, say next, if you want to repeat, say undo", productName);
                            play(help);
                        }
                    }
        ...
        private async Task InitializeRecognizer(Language recognize)
        {
            ...
            try
            {
                ...
                if (textBox.IsEnabled == true)
                {
                    var grammar = new[] { "wood", "leather", "cotton", "stone" };
