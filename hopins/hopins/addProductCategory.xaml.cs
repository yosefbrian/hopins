...
namespace hopins
{
    ...
    /// </summary>
    public sealed partial class addProductCategory : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var id = (addProductName.data)e.Parameter;
            textBlock.Text = id.path;
            textBlock1.Text = id.name;
                ...
                await dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () =>
                {
                    ...
                    if (textBox.IsEnabled == true)
                    {
                        ...
                        if (args.Result.Text != null)
                        {
                            ...
                            string help = string.Format("The type of your product is {0} , if the type is correct, say next, if you want to repeat, say undo", productName);
                            play(help);
                        }
                    }
        ...
        private async Task InitializeRecognizer(Language recognize)
        {
            ...
            try
            {
                ...
                if (textBox.IsEnabled == true)
                {
                    var grammar = new[] { "toys", "gifts", "fashion", "souvenir" };
